...
<body>
    ...
    <section id="content">
        ...
        <main id="resultsPage"><h1><span id="nombre">0</span><span id="super">ème</span> verre</h1><p>Servir une boissons <span id="drinkType">sans alcool</span></p><button>Scanner de nouveau</button></main>
